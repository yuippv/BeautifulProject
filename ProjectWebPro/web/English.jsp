<%-- 
    Document   : English
    Created on : Nov 20, 2019, 3:52:58 PM
    Author     : Acer
--%>
                ...
                <div class="row">
                    <div class="col-4">
                        <a href="GetLesson?lessonid=MTH101">      
                            <div class="card border-warning mb-3 cardBord" style="max-width: 20rem; ">
                                <div class="card-body">
                                    <h4 class="card-title">ENG101</h4>
                                    <p class="card-text">Present Tense</p>
                                </div>
                            </div>  
                        </a>
                    </div>
                    ...
                    <div class="col-4">
                        <div class="card border-warning mb-3 cardBord" style="max-width: 20rem; ">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">ENG301</h4>
                                <p class="card-text">Future Tense</p>
                            </div>
                        </div>
                    </div>
                </div>
