<%-- 
    Document   : Social
    Created on : Nov 20, 2019, 3:53:07 PM
    Author     : Acer
--%>
                    ...
                    <div class="col-4">
                        <a href="GetLesson?lessonid=MTH101">      
                            <div class="card border-warning mb-3 cardBord" style="max-width: 20rem; ">
                                <div class="card-body">
                                    <h4 class="card-title">SOC101</h4>
                                    <p class="card-text">Religion</p>
                                </div>
                            </div>  
                        </a>
                    </div>
